...
<div style="clear:both;"></div>
	<div class="classifybox">
		<div class="ttit">
			<ul>
				<li>分类：</li>
				<li><a href="Classify"><span>全部</span></a></li>
				<li><a href="Classify?cify=1"><span>人文</span></a></li>
				<li><a href="Classify?cify=2"><span>科学</span></a></li>
				<li><a href="Classify?cify=3"><span>语言</span></a></li>
				<li><a href="Classify?cify=4"><span>杂志</span></a></li>
				<li><a href="Classify?cify=5"><span>其他</span></a></li>
			</ul>
		</div>
	</div>
<div class="bodys">
